...
import ru.yandex.qatools.ashot.AShot;
	...
	public class WhiteList_MechantIP {
	    ...
	    @FindBy(xpath = "(//button[@class=\"multiselect dr"
	    		+ "opdown-toggle btn btn-default\"])[2]")
	  ...
	  //h3[normalize-space()='White list Master Merchant IP Details']
	    ...
	    public void interactWithfraudControlwhiteListMerchIP() throws InterruptedException, IOException {
